...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.giantsimulatorrebornwiki.wiki'
  const path = '/copyright'

  return {
    title: 'Copyright Notice - Giant Simulator Reborn Wiki',
    description: 'Copyright and intellectual property information for Giant Simulator Reborn Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: 'Giant Simulator Reborn Wiki',
      title: 'Copyright Notice - Giant Simulator Reborn Wiki',
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Giant Simulator Reborn Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Giant Simulator Reborn Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Giant Simulator Reborn Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
            ...
            <p>
              ...
              affiliation with Giant Simulator Reborn Wiki.
            </p>
            ...
            <p>
              ...
              Giant Simulator Reborn Wiki<br />
              Email: <a href="mailto:dmca@giantsimulatorrebornwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@giantsimulatorrebornwiki.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Giant Simulator Reborn Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Giant Simulator Reborn Wiki (giantsimulatorrebornwiki.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@giantsimulatorrebornwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@giantsimulatorrebornwiki.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@giantsimulatorrebornwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@giantsimulatorrebornwiki.wiki</a>
            </p>
            <p>
